...
from .decoder2 import DeepLabV3PlusDecoder
    ...
    def __init__(
       ...
       ###############################################################################################################################
        ...
        self.aspp = nn.Sequential(
            ASPP(self.encoder.out_channels[-3], decoder_channels, 128, decoder_atrous_rates, separable=True) #output of "green" feature map in the paper
        )
        ...
        self.sssr = sssr_extra_upsampling_module(classes)
...
def sssr_extra_upsampling_module(num_classes):
    out = nn.Sequential(
