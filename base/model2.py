...
class SegmentationModel(torch.nn.Module):
    ...
    def forward(self, x):
        ...
        aspp_features = self.aspp(features_resnet[-3]) # The output has shape (Bs, 128, H/16, W/16)
        ...
        sssr_decoder_out = self.sssr_decoder(aspp_features, features_resnet[0], features_resnet[1], features_resnet[2], features_resnet[3])
        ...
        sisr_decoder_out = self.sisr_decoder(aspp_features, features_resnet[0], features_resnet[1], features_resnet[2], features_resnet[3])
