### EXECUTE ONLY ONCE ! ###
# Convert all labels (gtFine_labelsIds) to label imgs with trainId pixel values (and save to disk):
import pickle
import numpy as np
import cv2
import os
...
cityscapes_data_path = "/mnt/gpid07/datasets/cityscapes" ### specify the folder where the dataset is stored in the server
cityscapes_meta_path = "/mnt/gpid07/imatge/sauc.abadal/datasets/cityscapes/meta" ### create a folder with the meta data in my home
...
img_dir = cityscapes_data_path + "/leftImg8bit_sequence/train/" ### add _sequence to the path
...
img_dir = cityscapes_data_path + "/leftImg8bit_sequence/val/" ### add _sequence to the path
